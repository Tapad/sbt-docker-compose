...
5) Optional: There are a number of optional Keys that can be set as well if you want to override the default settings:
    ...
    variablesForSubstitution =: // A Map[String,String] of variables to substitute in your docker-compose file.  These are passed as environment variables when calling docker-compose.
